                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.students.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('guardians_phone_no') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="guardians_phone_no" name="guardians_phone_no" class="form-control" value="{{ old('guardians_phone_no', isset($student) ? $student->guardians_phone_no : '07XX XXX XXX') }}">
